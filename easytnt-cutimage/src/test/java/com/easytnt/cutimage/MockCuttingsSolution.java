...
public class MockCuttingsSolution {
	...
	public static CuttingsSolution cuttingsSolution() {
		...
		//
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(1L, 0, 132, 1178,
		// 1049, 230));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(2L, 0, 122, 1350,
		// 1069, 722));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(3L, 0, 1164, 191,
		// 1025, 272));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(4L, 0, 1173, 431,
		// 1010, 735));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(5L, 0, 1165, 1113,
		// 1021, 1005));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(6L, 0, 2194, 1035,
		// 1023, 528));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(7L, 0, 2190, 1592,
		// 1018, 516));
		//
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(8L, 1, 78, 193,
		// 1033, 547));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(9L, 1, 72, 715,
		// 1054, 523));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(10L, 1, 80, 1181,
		// 1049, 526));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(11L, 1, 79, 1641,
		// 1037, 512));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(12L, 1, 1125, 200,
		// 1009, 771));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(13L, 1, 1121, 940,
		// 1027, 1219));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(14L, 1, 2146, 185,
		// 1035, 991));
		// cuttingsSolution.newCuttingsDefines(CuttingsArea(15L, 1, 2151, 1153,
		// 1029, 1012));
